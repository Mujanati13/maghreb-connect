...
import { Card, Input, Tabs, Tag, Typography, Dropdown, Menu, Badge } from 'antd';
...
const NotificationInterface = () => {
    ...
    if (loading) {
        return <Card><div>Chargement des notifications...</div></Card>;
    }

    if (error) {
        return <Card><div>Erreur: {error}</div></Card>;
    }
